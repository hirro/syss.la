...
This software is **dual-licensed** under the terms below.
...
**GNU Affero General Public License, version 3 (AGPL-3.0)** as published by  
the Free Software Foundation.

The AGPL ensures that if you modify this software and make it available  
to others over a network, you must also make the source code of your  
modifications publicly available under the same license.
...
© 2025 Jim Arnell. All rights reserved.
